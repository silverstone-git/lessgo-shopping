        ...
        return(
            <div>
                ...
                <form action="" onSubmit={(e) => {
                    ...
                    submitReview(rating, review, props.auth, props.itemId);
                }} className="flex flex-col mt-4">
                <label htmlFor="rating-input">Rating (out of 10)</label>
                <input required type="number" className="item-master-input mt-3" name="rating-input" id="rating-input" min={0} max={10} onChange={(e) => setRating(Number(e.target.value))}/>
