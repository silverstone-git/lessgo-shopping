                        ...
                        <div className=' border rounded border-slate-500 flex flex-col items-center justify-center'>
                            ...
                            <div className="flex flex-col justify-between items-center">
                                ...
                                <div className="flex justify-between my-3">
                                    <button onClick={(e) => console.log((e.target as HTMLElement).innerHTML)} className=" z-10 p-4 dark:bg-red-300 dark:text-slate-800 text-slate-100 bg-red-600 rounded-full border border-white mr-3">Delete</button>
